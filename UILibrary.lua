...
ScreenGuitwo.Name = "ManaNotifications"
...
local function getcustomassetfunc(path)
    if not betterisfile(path) then
        ...
        local req = requestfunc({
            Url = "https://raw.githubusercontent.com/MankaUser/ManaV2Reblox/main/"..path:gsub("Manka/Assets", "Assets"),
            Method = "GET"
        })
...
createnotification("Loaded", "Press N to toggle GUI", 3, true)
